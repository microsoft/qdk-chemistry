# QDK overlay: libaec (a default-feature dependency of hdf5 via szip).
#
# The libaec port in our pinned vcpkg baseline downloads 1.1.6 from
# gitlab.dkrz.de, which rate-limits (HTTP 429) as soon as several cold-cache
# jobs fetch it concurrently, and the vcpkg asset mirror has no copy of it.
# Upstream vcpkg switched the port to the GitHub mirror in microsoft/vcpkg#53051
# shortly after our baseline was taken; this overlay is a verbatim copy of that
# port so dependency installs stop depending on a rate-limited host.
#
# Remove this overlay once the vcpkg baseline in vcpkg-configuration.json is
# advanced past microsoft/vcpkg@9942fb5f99.
vcpkg_from_github(
