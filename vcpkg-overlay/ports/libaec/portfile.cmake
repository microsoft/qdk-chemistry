# Upstream's libaec 1.1.6 port downloads from gitlab.dkrz.de, which rate-limits
# (HTTP 429) and is not mirrored in the vcpkg asset cache, so a cold vcpkg build
# cannot fetch it. This overlay is that port with the source swapped for the
# project's official GitHub mirror -- byte-identical tarball, same version.
# Newer upstream ports (>= 1.1.7) already moved to this mirror, so this overlay
# can be dropped once the baseline advances past that.
vcpkg_from_github(
