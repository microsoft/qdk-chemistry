...
|-----------|-------------------|-----------|
| `StateVectorContainer` | Determinant expansion: single determinant (HF reference), Complete Active Space CI, or Selected CI | After SCF / CASCI / CASSCF / ASCI |
| `AmplitudeContainer` | T1/T2 excitation amplitudes relative to a reference (coupled cluster or MP2) | After CCSD / MP2 |
