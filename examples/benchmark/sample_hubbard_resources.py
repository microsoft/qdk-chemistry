...
# Total error budget: 0.0051 per site, including errors from phase estimation, Trotter, and
#: gate synthesis.
...
#: f, gives f = 2/3. Same optimum used in Campbell (arXiv:2012.09238v4, App. F).
