...
- `sossa_qre.ipynb`: Jupyter notebook estimating the cost of quantum phase estimation on a Hamiltonian block-encoded with SOSSA (sum-of-squares spectral amplification)
