...
| `sossa_qre.ipynb` | `pip install 'qdk-chemistry[jupyter,qre]'` |
...
- `sossa_qre.ipynb`: Jupyter notebook demonstrating quantum phase estimation with SOSSA (sum-of-squares spectral amplification) block encoding.
