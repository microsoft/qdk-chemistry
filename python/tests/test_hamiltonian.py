...
from qdk_chemistry.data import Canonical4CenterHamiltonian, Hamiltonian, ModelOrbitals, Orbitals
...
class TestHamiltonian:
    ...
    def test_full_constructor(self):
        ...
        h = Hamiltonian(Canonical4CenterHamiltonian(one_body, two_body, orbitals, 1.5, np.array([])))
        assert h.has_one_body_integrals()
        assert h.has_two_body_integrals()
        assert h.has_orbitals()
    ...
    def test_one_body_integrals(self):
        ...
        h = Hamiltonian(Canonical4CenterHamiltonian(one_body, two_body, orbitals, 0.0, np.array([])))
        assert h.has_one_body_integrals()
    ...
    def test_active_space_management(self):
        ...
        h = Hamiltonian(Canonical4CenterHamiltonian(one_body, two_body, orbitals, 2.5, np.array([])))
    ...
    def test_static_methods_exist(self):
        ...
        orbitals = Orbitals(coeffs, None, None, create_test_basis_set(2))
        fock = np.array([])
        h = Hamiltonian(Canonical4CenterHamiltonian(one_body, two_body, orbitals, 1.5, fock))
    ...
    def test_restricted_hamiltonian_construction(self):
        ...
        h = Hamiltonian(Canonical4CenterHamiltonian(one_body, two_body, orbitals, 1.0, inactive_fock))
    ...
    def test_unrestricted_vs_restricted_serialization(self):
        ...
        h_restricted = Hamiltonian(Canonical4CenterHamiltonian(one_body, two_body, orbitals_restricted, 1.0, np.eye(2)))
    ...
    def test_active_space_consistency(self):
        ...
        h_restricted = Hamiltonian(
            Canonical4CenterHamiltonian(one_body, two_body, model_orbitals_restricted, 0.0, np.eye(4))
        )
