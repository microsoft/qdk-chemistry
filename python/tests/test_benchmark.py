...
_HUBBARD_L2 = BenchmarkResults(
    results={
        "algorithm": {
            ...
            "base_time": 0.4116441986871221,
            "t_max": 421.523659455613,
            "qpe_type": "standard-one-step-scaled",
            "max_power": 512,
            "num_unitary_queries": 1023,
            "power_strategy": "rescale",
            "effective_evolution_time": 210.7618297278065,
            "trotter_budget": 0.0068,
            "num_divisions": 0,
            "resolved_num_divisions": 39571,
            "num_divisions_for_largest_step": 39571,
            "steps_per_bit": "[78, 155, 310, 619, 1237, 2474, 4947, 9893, 19786, 39571]",
            "total_trotter_steps": 79070,
            "trotter_step_time": 0.005326168904698,
            "step_max_error": 6.323510813203491e-07,
            "num_bits": 10,
        },
        "frontier": [
            {
                ...
                "ladder_runtime_s": 3502.4847200000004,
                "ladder_runtime_days": 0.0405380175925925,
                "step_error": 5.537454922547237e-07,
                "error": 0.043784656072581,
            },
            {
                "name": "2x2-step",
                "qubits": 37493,
                ...
                "ladder_runtime_s": 2787.69192,
                "ladder_runtime_days": 0.0322649527777777,
                "step_error": 5.537484982277561e-07,
                "error": 0.0437848937548686,
            },
            {
                "name": "2x2-step",
                "qubits": 42037,
                ...
                "ladder_runtime_s": 2072.89912,
                "ladder_runtime_days": 0.0239918879629629,
                "step_error": 5.690789606929511e-07,
                "error": 0.0449970734219916,
            },
            {
                "name": "2x2-step",
                "qubits": 50901,
                ...
                "ladder_runtime_s": 1715.50272,
                "ladder_runtime_days": 0.0198553555555555,
                "step_error": 5.608203727070247e-07,
                "error": 0.0443440668699444,
            },
        ],
    },
)
