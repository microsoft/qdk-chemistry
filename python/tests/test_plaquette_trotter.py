...
def _qsharp_groups(groups: Sequence[ExponentiatedPauliTerm | BatchedExponentiatedPauliTerm]) -> str:
...
class TestHammingWeightPhasing:
    ...
    def test_unbounded_batches_merge_the_interaction_families(self):
        """Capping batches trades rotations for width without changing the operator."""
        side = 4
