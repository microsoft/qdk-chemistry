...
from qdk_chemistry.algorithms.hadamard_test.hadamard_test_generator import (
...
def water_hadamard_benchmark() -> HadamardWaterBenchmark:
    ...
    ctrl_time_evolution_circuit = circuit_mapper._run_impl(controlled_evolution=controlled_evolution)  # noqa: SLF001
...
def test_qiskit_hadamard_generator_measures_water_observable(
    ...
    assert np.isclose(observable_value, 0.14, atol=1e-12)
