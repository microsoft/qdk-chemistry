...
def test_basis_set_construction():
    ...
    shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0])

    # Test constructor with name and shells (minimal)
    basis = qdk.chemistry.data.BasisSet("", [shell])
    assert basis.get_name() == ""
    assert basis.get_basis_type() == qdk.chemistry.data.BasisType.Spherical
    assert basis.get_num_shells() == 1
    assert basis.get_num_basis_functions() == 1

    # Test constructor with name and shells
    basis_named = qdk.chemistry.data.BasisSet("6-31G", [shell])
    assert basis_named.get_name() == "6-31G"
    assert basis_named.get_basis_type() == qdk.chemistry.data.BasisType.Spherical
    assert basis_named.get_num_shells() == 1

    # Test constructor with name, shells, and basis type
    basis_cartesian = qdk.chemistry.data.BasisSet("6-31G", [shell], qdk.chemistry.data.BasisType.Cartesian)
    assert basis_cartesian.get_name() == "6-31G"
    assert basis_cartesian.get_basis_type() == qdk.chemistry.data.BasisType.Cartesian

    # Test copy constructor
    basis_copy = qdk.chemistry.data.BasisSet(basis_cartesian)
    assert basis_copy.get_name() == "6-31G"
    assert basis_copy.get_basis_type() == qdk.chemistry.data.BasisType.Cartesian
...
def test_shell_management():
    ...
    shells = [
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, [0.5], [1.0]),
    ]
    basis = qdk.chemistry.data.BasisSet("STO-3G", shells)
    ...
    assert all_shells[0].orbital_type == qdk.chemistry.data.OrbitalType.S
    assert all_shells[1].orbital_type == qdk.chemistry.data.OrbitalType.P

    # Get shells for atom 0
    atom_shells = basis.get_shells_for_atom(0)
    assert len(atom_shells) == 2
    assert atom_shells[0].orbital_type == qdk.chemistry.data.OrbitalType.S
    assert atom_shells[1].orbital_type == qdk.chemistry.data.OrbitalType.P

    # Get specific shell
    shell_0 = basis.get_shell(0)
    assert shell_0.orbital_type == qdk.chemistry.data.OrbitalType.S
    ...
    shell_obj = qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.S, exponents, coefficients)
    ...
    basis_extended = qdk.chemistry.data.BasisSet("STO-3G-extended", all_shells)
...
def test_basis_type_management():
    ...
    basis_spherical = qdk.chemistry.data.BasisSet("test", [shell])
    assert basis_spherical.get_basis_type() == qdk.chemistry.data.BasisType.Spherical

    # Test cartesian basis type with d orbital shell
    shells = [qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.D, [1.0], [2.0])]
    basis_cartesian = qdk.chemistry.data.BasisSet("test", shells, qdk.chemistry.data.BasisType.Cartesian)
    assert basis_cartesian.get_basis_type() == qdk.chemistry.data.BasisType.Cartesian
    ...
    basis_sph_test = qdk.chemistry.data.BasisSet("test", shells, qdk.chemistry.data.BasisType.Spherical)
...
def test_shell_with_raw_primitives():
    ...
    shells = [qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, exponents, coefficients)]
    basis = qdk.chemistry.data.BasisSet("cc-pVDZ", shells)
    ...
    p_shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, exponents_np, coefficients_np)

    # Create a new basis set with both shells
    all_shells = [qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, exponents, coefficients), p_shell]
    basis_extended = qdk.chemistry.data.BasisSet("cc-pVDZ-extended", all_shells)
...
def test_orbital_type_enum():
    ...
    assert qdk.chemistry.data.OrbitalType.S != qdk.chemistry.data.OrbitalType.P

    # Test utility functions
    assert qdk.chemistry.data.BasisSet.orbital_type_to_string(qdk.chemistry.data.OrbitalType.S) == "s"
    assert qdk.chemistry.data.BasisSet.orbital_type_to_string(qdk.chemistry.data.OrbitalType.P) == "p"
    assert qdk.chemistry.data.BasisSet.orbital_type_to_string(qdk.chemistry.data.OrbitalType.D) == "d"
    # Test higher angular momentum orbitals
    assert qdk.chemistry.data.BasisSet.orbital_type_to_string(qdk.chemistry.data.OrbitalType.F) == "f"
    assert qdk.chemistry.data.BasisSet.orbital_type_to_string(qdk.chemistry.data.OrbitalType.G) == "g"
    assert qdk.chemistry.data.BasisSet.orbital_type_to_string(qdk.chemistry.data.OrbitalType.H) == "h"
    assert qdk.chemistry.data.BasisSet.orbital_type_to_string(qdk.chemistry.data.OrbitalType.I) == "i"

    assert qdk.chemistry.data.BasisSet.string_to_orbital_type("s") == qdk.chemistry.data.OrbitalType.S
    assert qdk.chemistry.data.BasisSet.string_to_orbital_type("p") == qdk.chemistry.data.OrbitalType.P
    assert qdk.chemistry.data.BasisSet.string_to_orbital_type("d") == qdk.chemistry.data.OrbitalType.D
    # Test higher angular momentum string conversions
    assert qdk.chemistry.data.BasisSet.string_to_orbital_type("f") == qdk.chemistry.data.OrbitalType.F
    assert qdk.chemistry.data.BasisSet.string_to_orbital_type("g") == qdk.chemistry.data.OrbitalType.G
    assert qdk.chemistry.data.BasisSet.string_to_orbital_type("h") == qdk.chemistry.data.OrbitalType.H
    assert qdk.chemistry.data.BasisSet.string_to_orbital_type("i") == qdk.chemistry.data.OrbitalType.I

    # Test angular momentum
    assert qdk.chemistry.data.BasisSet.get_angular_momentum(qdk.chemistry.data.OrbitalType.S) == 0
    assert qdk.chemistry.data.BasisSet.get_angular_momentum(qdk.chemistry.data.OrbitalType.P) == 1
    assert qdk.chemistry.data.BasisSet.get_angular_momentum(qdk.chemistry.data.OrbitalType.D) == 2
    assert qdk.chemistry.data.BasisSet.get_angular_momentum(qdk.chemistry.data.OrbitalType.F) == 3
    assert qdk.chemistry.data.BasisSet.get_angular_momentum(qdk.chemistry.data.OrbitalType.G) == 4
    assert qdk.chemistry.data.BasisSet.get_angular_momentum(qdk.chemistry.data.OrbitalType.H) == 5
    assert qdk.chemistry.data.BasisSet.get_angular_momentum(qdk.chemistry.data.OrbitalType.I) == 6

    # Test orbital sizes for different basis types
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(0, qdk.chemistry.data.BasisType.Spherical) == 1
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(1, qdk.chemistry.data.BasisType.Spherical) == 3
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(2, qdk.chemistry.data.BasisType.Spherical) == 5

    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(0, qdk.chemistry.data.BasisType.Cartesian) == 1
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(1, qdk.chemistry.data.BasisType.Cartesian) == 3
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(2, qdk.chemistry.data.BasisType.Cartesian) == 6

    # Test basis type string conversion
    assert qdk.chemistry.data.BasisSet.basis_type_to_string(qdk.chemistry.data.BasisType.Spherical) == "spherical"
    assert qdk.chemistry.data.BasisSet.basis_type_to_string(qdk.chemistry.data.BasisType.Cartesian) == "cartesian"

    assert qdk.chemistry.data.BasisSet.string_to_basis_type("spherical") == qdk.chemistry.data.BasisType.Spherical
    assert qdk.chemistry.data.BasisSet.string_to_basis_type("cartesian") == qdk.chemistry.data.BasisType.Cartesian
...
def test_basis_function_queries():
    ...
    shells = [
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # atom 0: 1 s orbital
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, [0.5], [1.0]),  # atom 0: 3 p orbitals
        qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # atom 1: 1 s orbital
    ]
    basis = qdk.chemistry.data.BasisSet("Test", shells)
...
def test_shell_queries():
    ...
    # Create shells
    shells = [
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # shell 0
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, [0.5], [1.0]),  # shell 1
        qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # shell 2
    ]
    basis = qdk.chemistry.data.BasisSet("Test", shells)
    ...
    s_shells = basis.get_shell_indices_for_orbital_type(qdk.chemistry.data.OrbitalType.S)
    assert s_shells == [0, 2]

    p_shells = basis.get_shell_indices_for_orbital_type(qdk.chemistry.data.OrbitalType.P)
    assert p_shells == [1]
    ...
    assert basis.get_num_basis_functions_for_orbital_type(qdk.chemistry.data.OrbitalType.S) == 2  # 2 s orbitals
    assert basis.get_num_basis_functions_for_orbital_type(qdk.chemistry.data.OrbitalType.P) == 3  # 3 p orbitals


def test_basis_function_info():
    """Test basis function info functionality."""
    shells = [qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, [1.0], [1.0])]  # 3 p orbitals
    basis = qdk.chemistry.data.BasisSet("Test", shells)
...
def test_structure_integration():
    ...
    structure = qdk.chemistry.data.Structure(coords, nuclear_charges)

    # Create shells consistent with structure
    shells = [
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # O 1s
        qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # H 1s
        qdk.chemistry.data.Shell(2, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # H 1s
    ]
    basis = qdk.chemistry.data.BasisSet("STO-3G", shells, structure)
...
def test_summary():
    ...
    basis = qdk.chemistry.data.BasisSet("6-31G", shells)
...
def test_json_serialization():
    ...
    basis_out = qdk.chemistry.data.BasisSet("STO-3G", shells)
    ...
    basis_in = qdk.chemistry.data.BasisSet.from_json(json_data)
    ...
    try:
        ...
        basis_file = qdk.chemistry.data.BasisSet.from_json_file(filename)
...
def test_hdf5_serialization():
    ...
    basis_out = qdk.chemistry.data.BasisSet("cc-pVDZ", shells, qdk.chemistry.data.BasisType.Spherical)
    ...
    try:
        ...
        basis_in = qdk.chemistry.data.BasisSet.from_hdf5_file(filename)
...
def test_error_handling():
    ...
    shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0])
    basis = qdk.chemistry.data.BasisSet("Test", [shell])
    ...
    with pytest.raises(ValueError):  # noqa: PT011
        qdk.chemistry.data.BasisSet.string_to_orbital_type("invalid")
...
def test_complete_basis_set_workflow():
    ...
    shells = [
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # H1 1s
        qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0]),  # H2 1s
    ]
    ...
    try:
        ...
        # Load from JSON file
        basis2 = qdk.chemistry.data.BasisSet.from_json_file(json_filename)
...
def test_shell_creation():
    ...
    shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [0.5])
    assert shell.atom_index == 0
    assert shell.orbital_type == qdk.chemistry.data.OrbitalType.S
    ...
    shell2 = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0, 2.0], [0.5, 0.3])
    ...
    p_shell = qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.P, [1.0], [1.0])
    assert p_shell.get_num_basis_functions(qdk.chemistry.data.BasisType.Spherical) == 3  # px, py, pz
    assert p_shell.get_num_basis_functions(qdk.chemistry.data.BasisType.Cartesian) == 3  # same for p
    assert p_shell.get_angular_momentum() == 1

    # Test d shell with different basis types
    d_shell = qdk.chemistry.data.Shell(2, qdk.chemistry.data.OrbitalType.D, [1.0], [1.0])
    assert d_shell.get_num_basis_functions(qdk.chemistry.data.BasisType.Spherical) == 5  # spherical d
    assert d_shell.get_num_basis_functions(qdk.chemistry.data.BasisType.Cartesian) == 6  # cartesian d

    # Test shell creation with raw primitive data
    exponents = [1.0, 2.0, 3.0]
    coefficients = [0.1, 0.2, 0.3]
    contracted_shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, exponents, coefficients)
    ...
    contracted_shell_np = qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.P, exponents_np, coefficients_np)
...
def test_utility_functions():
    ...
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(0) == 1  # s: 1 orbital
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(1) == 3  # p: 3 orbitals
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(2) == 5  # d: 5 orbitals
    assert qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(3) == 7  # f: 7 orbitals

    # Cartesian
    assert (
        qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(0, qdk.chemistry.data.BasisType.Cartesian) == 1
    )  # s: 1 orbital
    assert (
        qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(1, qdk.chemistry.data.BasisType.Cartesian) == 3
    )  # p: 3 orbitals
    assert (
        qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(2, qdk.chemistry.data.BasisType.Cartesian) == 6
    )  # d: 6 orbitals
    assert (
        qdk.chemistry.data.BasisSet.get_num_orbitals_for_l(3, qdk.chemistry.data.BasisType.Cartesian) == 10
    )  # f: 10 orbitals
...
def test_basis_set_file_io_generic():
    ...
    s_shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, [1.0], [1.0])
    shells.append(s_shell)

    # Create p shell for atom 0
    p_shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, [0.5], [0.8])
    shells.append(p_shell)

    # Create s shell for atom 1
    s_shell2 = qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.S, [2.0], [0.9])
    ...
    with tempfile.NamedTemporaryFile(suffix=".basis_set.json") as tmp_json:
        ...
        basis2 = qdk.chemistry.data.BasisSet.from_file(json_filename, "json")
    ...
    with tempfile.NamedTemporaryFile(suffix=".basis_set.h5") as tmp_hdf5:
        ...
        # Load using generic method
        basis3 = qdk.chemistry.data.BasisSet.from_file(hdf5_filename, "hdf5")
    ...
    with pytest.raises(RuntimeError, match="Unsupported file type"):
        basis = qdk.chemistry.data.BasisSet.from_file("test.basis_set.xyz", "xyz")
...
def test_basis_set_hdf5_specific():
    ...
    s_shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, exponents_s, coefficients_s)
    shells.append(s_shell)

    exponents_p = np.array([2.94124940, 0.68348310, 0.22228990])
    coefficients_p = np.array([-0.09996723, 0.39951283, 0.70011547])
    p_shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, exponents_p, coefficients_p)
    shells.append(p_shell)
    ...
    with tempfile.NamedTemporaryFile(suffix=".basis_set.h5") as tmp_hdf5:
        ...
        basis2 = qdk.chemistry.data.BasisSet.from_hdf5_file(hdf5_filename)
...
def test_basis_set_json_specific():
    ...
    # Create a basis set with multiple shells
    basis = qdk.chemistry.data.BasisSet("cc-pVDZ", shells, qdk.chemistry.data.BasisType.Cartesian)
...
def test_basis_set_file_io_validation():
    ...
    basis = qdk.chemistry.data.BasisSet("STO-3G", [s_shell])
    ...
    with pytest.raises(ValueError, match=re.escape("'.basis_set.' before the file extension")):
        basis = qdk.chemistry.data.BasisSet.from_json_file("test.json")
    ...
    with pytest.raises(ValueError, match=re.escape("'.basis_set.' before the file extension")):
        basis = qdk.chemistry.data.BasisSet.from_hdf5_file("test.h5")

    # Test non-existent file
    with pytest.raises(RuntimeError, match="Cannot open file for reading"):
        basis = qdk.chemistry.data.BasisSet.from_json_file("nonexistent.basis_set.json")

    with pytest.raises(RuntimeError):
        basis = qdk.chemistry.data.BasisSet.from_hdf5_file("nonexistent.basis_set.h5")
...
def test_basis_set_file_io_round_trip():
    ...
    s_shell0 = qdk.chemistry.data.Shell(
        0, qdk.chemistry.data.OrbitalType.S, np.array([1.24, 0.32]), np.array([0.6, 0.4])
    )
    shells.append(s_shell0)
    p_shell0 = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, np.array([0.8, 0.2]), np.array([0.7, 0.3]))
    shells.append(p_shell0)

    # Atom 1: C-like with s, p, and d shells
    s_shell1 = qdk.chemistry.data.Shell(
        1,
        qdk.chemistry.data.OrbitalType.S,
        np.array([5.033151, 1.254400, 0.331126]),
        np.array([0.156285, 0.607684, 0.391957]),
    )
    shells.append(s_shell1)
    p_shell1 = qdk.chemistry.data.Shell(
        1,
        qdk.chemistry.data.OrbitalType.P,
        np.array([2.941249, 0.683483, 0.222289]),
        np.array([0.156285, 0.607684, 0.391957]),
    )
    shells.append(p_shell1)
    d_shell1 = qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.D, np.array([0.8, 0.2]), np.array([0.5, 0.5]))
    shells.append(d_shell1)

    # Create a complex basis set with all shells
    basis = qdk.chemistry.data.BasisSet("complex-basis", shells, qdk.chemistry.data.BasisType.Spherical)
    ...
    with tempfile.NamedTemporaryFile(suffix=".basis_set.json") as tmp_json:
        ...
        # Save and reload
        basis.to_json_file(json_filename)
        basis_json = qdk.chemistry.data.BasisSet.from_json_file(json_filename)
    ...
    with tempfile.NamedTemporaryFile(suffix=".basis_set.h5") as tmp_hdf5:
        ...
        # Save and reload
        basis.to_hdf5_file(hdf5_filename)
        basis_hdf5 = qdk.chemistry.data.BasisSet.from_hdf5_file(hdf5_filename)
...
def test_basis_set_consistency_between_methods():
    ...
    s_shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, np.array([2.0, 0.5]), np.array([0.8, 0.2]))
    shells.append(s_shell)
    p_shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, np.array([1.5, 0.3]), np.array([0.7, 0.3]))
    shells.append(p_shell)

    # Create basis with shells
    basis = qdk.chemistry.data.BasisSet("test-consistency", shells)
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        basis1 = qdk.chemistry.data.BasisSet.from_file(json_file1, "json")
        basis2 = qdk.chemistry.data.BasisSet.from_json_file(json_file2)
        ...
        basis3 = qdk.chemistry.data.BasisSet.from_file(hdf5_file1, "hdf5")
        basis4 = qdk.chemistry.data.BasisSet.from_hdf5_file(hdf5_file2)
...
def test_basis_set_metadata_management():
    ...
    basis = qdk.chemistry.data.BasisSet("", shells)
    assert basis.get_name() == ""

    # Test by creating a copy and modifying name (set_name method may not exist)
    # Instead test constructor with name
    basis_named = qdk.chemistry.data.BasisSet("Custom-Basis", shells)
    assert basis_named.get_name() == "Custom-Basis"

    # Test constructor with name and basis type
    basis_with_type = qdk.chemistry.data.BasisSet("6-31G", shells, qdk.chemistry.data.BasisType.Cartesian)
    assert basis_with_type.get_name() == "6-31G"
    assert basis_with_type.get_basis_type() == qdk.chemistry.data.BasisType.Cartesian

    # Test copy constructor
    basis_copy = qdk.chemistry.data.BasisSet(basis_with_type)
    assert basis_copy.get_name() == "6-31G"
    assert basis_copy.get_basis_type() == qdk.chemistry.data.BasisType.Cartesian
    ...
    symbols = ["H"]
    structure = qdk.chemistry.data.Structure(coords, symbols)

    # Test basis set with structure
    basis_with_structure = qdk.chemistry.data.BasisSet("H-basis", shells, structure)
...
def test_keyword_arguments():
    ...
    coefficients = np.array([1.0])
    shell1 = qdk.chemistry.data.Shell(
        atom_index=0, orbital_type=qdk.chemistry.data.OrbitalType.S, exponents=exponents, coefficients=coefficients
    )
    assert shell1.atom_index == 0
    assert shell1.orbital_type == qdk.chemistry.data.OrbitalType.S
    ...
    shell2 = qdk.chemistry.data.Shell(
        atom_index=1,
        orbital_type=qdk.chemistry.data.OrbitalType.P,
    ...
    shells = [shell1]
    basis1 = qdk.chemistry.data.BasisSet(name="STO-3G", shells=shells)
    assert basis1.get_name() == "STO-3G"

    # Test BasisSet constructor with name and basis_type using keyword args
    basis2 = qdk.chemistry.data.BasisSet(name="6-31G", shells=shells, basis_type=qdk.chemistry.data.BasisType.Cartesian)
    assert basis2.get_name() == "6-31G"
    assert basis2.get_basis_type() == qdk.chemistry.data.BasisType.Cartesian

    # Note: set_basis_type and add_shell methods don't exist on BasisSet
    # Test get_basis_type instead
    assert basis1.get_basis_type() == qdk.chemistry.data.BasisType.Spherical  # Default
    assert basis2.get_basis_type() == qdk.chemistry.data.BasisType.Cartesian
...
def test_explicit_pyarg_coverage():
    ...
    exponents = np.array([1.0])
    coefficients = np.array([1.0])
    shell_basic = qdk.chemistry.data.Shell(
        atom_index=0, orbital_type=qdk.chemistry.data.OrbitalType.S, exponents=exponents, coefficients=coefficients
    )
    ...
    exponents_vec = np.array([1.0, 2.0])
    coefficients_vec = np.array([0.5, 0.5])
    shell_vector = qdk.chemistry.data.Shell(
        atom_index=1,
        orbital_type=qdk.chemistry.data.OrbitalType.P,
        exponents=exponents_vec,
        coefficients=coefficients_vec,
    ...
    shells = [shell_basic]
    basis1 = qdk.chemistry.data.BasisSet(name="Test-Basis", shells=shells)

    # BasisSet(name, shells, basis_type) py::arg
    basis2 = qdk.chemistry.data.BasisSet(
        name="Test-Basis-2", shells=shells, basis_type=qdk.chemistry.data.BasisType.Cartesian
    )
...
def test_explicit_shell_constructor_coverage():
    ...
    shell = qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.S, exponents, coefficients)
    ...
    shell_p = qdk.chemistry.data.Shell(1, qdk.chemistry.data.OrbitalType.P, p_exponents, p_coefficients)
...
def test_basis_set_pickling_and_repr():
    ...
    shells = [
        qdk.chemistry.data.Shell(
            0, qdk.chemistry.data.OrbitalType.S, [3.425251, 0.623914, 0.168855], [0.154329, 0.535328, 0.444635]
        ),
        qdk.chemistry.data.Shell(0, qdk.chemistry.data.OrbitalType.P, [1.158, 0.325], [0.155916, 0.607684]),
    ]
    original = qdk.chemistry.data.BasisSet("STO-3G", shells)
