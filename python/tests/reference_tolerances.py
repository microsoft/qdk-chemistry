...
# This is the orthonormality error tolerance to check for orthonormality.
# If the error is below this tolerance, orthonormality is confirmed.
orthonormality_error_tolerance = 1e-10
...
# This is the RDM convergence tolerance used for the reference values.
# Consistency of the tested modules can only be expected to agree up to this tolerance.
rdm_tolerance = 1e-6
...
# This is the SCI energy convergence tolerance used for the reference values.
# Consistency of the tested modules can only be expected to agree up to this tolerance.
sci_energy_tolerance = 1e-6

# This is the unitarity error tolerance to check for unitarity.
# If the error is below this tolerance, unitarity is confirmed.
unitarity_error_tolerance = 1e-10
