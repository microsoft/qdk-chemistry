...
from qdk.chemistry.algorithms import ActiveSpaceSelector, register
from qdk.chemistry.data import Configuration, Orbitals, Settings, SlaterDeterminantContainer, Wavefunction
from qdk.chemistry.plugins.pyscf.utils import orbitals_to_scf
        ...
        for label in ao_labels:
            ...
            if atom_symb in atom_symbols:
                ...
                if count > 1:
                    ...
                    ao_labels_clean.append(label)
            # TODO (NAB):  is this if/elif block missing an else?
            # https://dev.azure.com/ms-azurequantum/AzureQuantum/_workitems/edit/41403
