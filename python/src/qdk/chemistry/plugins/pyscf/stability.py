...
from qdk.chemistry.algorithms import StabilityChecker, register
from qdk.chemistry.data import Settings, StabilityResult, Wavefunction
...
class PyscfStabilityChecker(StabilityChecker):
    ...
    def _run_impl(self, wavefunction: Wavefunction) -> tuple[bool, StabilityResult]:
        ...
        occ_alpha = np.zeros(nmos)
        occ_beta = np.zeros(nmos)
