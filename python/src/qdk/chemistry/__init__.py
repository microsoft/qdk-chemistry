...
from qdk.chemistry._core import QDKChemistryConfig
...
def _setup_resources() -> None:
    ...
    locations withthe following precedence:
...
# Try to import pyscf and other known plugins early so it's registered before stub generation
# This happens when qdk.chemistry.algorithms is imported
with contextlib.suppress(ImportError):
    import qdk.chemistry.plugins.pyscf
    import qdk.chemistry.plugins.qiskit
...
def _generate_registry_stubs() -> None:
    ...
    try:
        ...
        from qdk.chemistry.algorithms import registry as reg_module  # noqa: PLC0415
        ...
        for algorithm_type, algorithm_names in all_algorithms.items():
            for algorithm_name in algorithm_names:
                try:
                    ...
                    if class_module == "qdk.chemistry._core._algorithms":
                        class_module = "qdk.chemistry.algorithms"
