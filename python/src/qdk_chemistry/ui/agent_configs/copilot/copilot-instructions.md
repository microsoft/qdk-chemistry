...
Use `run_resource_estimation` on any circuit file (state preparation, QPE, controlled-U) to get the full profile. The default estimator (`qdk_qre_v3`) uses the QRE v3 backend to explore the Pareto frontier of qubits/runtime tradeoffs.
