...
Auto-generated from ExaChem's ducc-t_ccsd.hpp by generate_bch_contractions_all.py.
...
def f_3(
    ...
    vt["iabc"] += ((-1 / 12) * np.einsum("eamn,of,cbmn,efio->iabc", t2, f1, t2, t2))[
        np.ix_(OI, VI, VI, VI)
    ]  # [T_int=0]
    ...
    vt["ijab"] += ((-1 / 12) * np.einsum("efmn,oj,abim,efno->ijab", t2, f1, t2, t2))[
        np.ix_(OI, OI, VI, VI)
    ]  # [T_int=0]
    ...
    vt["ijab"] += ((-1 / 24) * np.einsum("efmn,oj,efio,abmn->ijab", t2, f1, t2, t2))[
        np.ix_(OI, OI, VI, VI)
    ]  # [T_int=0]
