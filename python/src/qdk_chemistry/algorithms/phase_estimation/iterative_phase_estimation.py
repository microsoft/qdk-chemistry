...
the largest controlled power :math:`U^{2^{m-1}}` and therefore measures the least-significant
bit; subsequent iterations proceed toward the most-significant bit.
