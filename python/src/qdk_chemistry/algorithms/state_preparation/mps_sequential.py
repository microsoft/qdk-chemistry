...
exploiting symmetry-induced block-sparsity." (2026). [https://zenodo.org/records/20393500].
...
3. Guang Hao Low et al. "Fast quantum simulation of electronic structure by spectrum 
amplification." Phys. Rev. X 15, 041016 (2025). [arXiv:2502.15882]
"""
...
class MPSSequentialStatePreparation(StatePreparation):
    ...
    See also:
        - Rupprecht & Wölk, Zenodo: https://zenodo.org/records/20393500
        - Sapova, Plekhanov, & Sherrill, PRX Quantum 6, 020327 (2025)
        - Berry et al., arXiv:2502.15882
    """
