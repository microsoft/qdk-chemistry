...
def _register_python_factories():
    ...
    from qdk_chemistry.algorithms.phase_estimation.builder import PhaseEstimationBuilderFactory  # noqa: PLC0415
    ...
    register_factory(PhaseEstimationBuilderFactory())
...
def _register_python_algorithms():
    ...
    from qdk_chemistry.algorithms.phase_estimation.builder.iterative_builder import (  # noqa: PLC0415
    ...
    register(lambda: IterativePhaseEstimationBuilder())
