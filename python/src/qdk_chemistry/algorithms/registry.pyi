...
import qdk_chemistry.algorithms.hamiltonian_unitary.builder.partially_randomized
import qdk_chemistry.algorithms.hamiltonian_unitary.builder.qdrift
import qdk_chemistry.algorithms.hamiltonian_unitary.builder.trotter
import qdk_chemistry.algorithms.hamiltonian_unitary.controlled_circuit_mapper.pauli_sequence_mapper
...
) -> qdk_chemistry.algorithms.hamiltonian_unitary.builder.trotter.Trotter: ...
...
def create(
    ...
    seed: unknown = -1,
) -> qdk_chemistry.algorithms.hamiltonian_unitary.builder.qdrift.QDrift: ...
...
) -> qdk_chemistry.algorithms.hamiltonian_unitary.builder.partially_randomized.PartiallyRandomized: ...
...
def create(
    ...
    power: unknown = 1,
) -> qdk_chemistry.algorithms.hamiltonian_unitary.controlled_circuit_mapper.pauli_sequence_mapper.PauliSequenceMapper: ...
