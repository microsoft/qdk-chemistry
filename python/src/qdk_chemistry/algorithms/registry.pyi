...
import qdk_chemistry.algorithms.controlled_circuit_mapper.pauli_sequence_mapper
...
import qdk_chemistry.algorithms.hamiltonian_unitary_builder.time_evolution.partially_randomized
import qdk_chemistry.algorithms.hamiltonian_unitary_builder.time_evolution.qdrift
import qdk_chemistry.algorithms.hamiltonian_unitary_builder.time_evolution.trotter
...
import qdk_chemistry.algorithms.term_grouper.commuting
import qdk_chemistry.algorithms.term_grouper.identity
import qdk_chemistry.algorithms.time_evolution.circuit_mapper.pauli_sequence_mapper
import qdk_chemistry.algorithms.time_evolution.measure_simulation.evolve_and_measure
import qdk_chemistry.plugins.networkx.term_grouper
import qdk_chemistry.plugins.openfermion.qubit_mapper
...
import qdk_chemistry.plugins.qiskit.circuit_executor
import qdk_chemistry.plugins.qiskit.qubit_mapper
import qdk_chemistry.plugins.qiskit.regular_isometry
import qdk_chemistry.plugins.qiskit.standard_phase_estimation
...
def create(
    ...
    threshold: float = 0.2,
) -> qdk_chemistry.plugins.pyscf.active_space_avas.PyscfAVAS: ...
...
) -> qdk_chemistry.plugins.pyscf.localization.PyscfLocalizer: ...
...
def create(
    ...
    multi_configuration_calculator: AlgorithmRef = AlgorithmRef(type='multi_configuration_calculator', name='macis_cas'),
    verbose: unknown = 0,
) -> qdk_chemistry.plugins.pyscf.mcscf.PyscfMcscfCalculator: ...
...
) -> qdk_chemistry.plugins.pyscf.coupled_cluster.PyscfCoupledClusterCalculator: ...
...
def create(
    ...
    scf_type: str = "auto",
    xc_grid: unknown = 3,
) -> qdk_chemistry.plugins.pyscf.scf_solver.PyscfScfSolver: ...
...
def create(
    ...
    xc_grid: unknown = 3,
) -> qdk_chemistry.plugins.pyscf.stability.PyscfStabilityChecker: ...
...
@overload
def create(
    algorithm_type: Literal['evolution_circuit_mapper'],
    algorithm_name: Literal['pauli_sequence'] | None = None,
) -> qdk_chemistry.algorithms.time_evolution.circuit_mapper.pauli_sequence_mapper.PauliSequenceMapper: ...

@overload
def create(
    algorithm_type: Literal['measure_simulation'],
    algorithm_name: Literal['evolve_and_measure'] | None = None,
    circuit_executor: AlgorithmRef = AlgorithmRef(type='circuit_executor', name='qdk_sparse_state_simulator'),
    circuit_mapper: AlgorithmRef = AlgorithmRef(type='evolution_circuit_mapper', name='pauli_sequence'),
    energy_estimator: AlgorithmRef = AlgorithmRef(type='energy_estimator', name='qdk'),
    evolution_builder: AlgorithmRef = AlgorithmRef(type='hamiltonian_unitary_builder', name='trotter'),
) -> qdk_chemistry.algorithms.time_evolution.measure_simulation.evolve_and_measure.EvolveAndMeasure: ...
...
) -> qdk_chemistry.algorithms.term_grouper.commuting.FullCommutingTermGrouper: ...

@overload
def create(
    algorithm_type: Literal['term_grouper'],
    algorithm_name: Literal['qubit_wise_commuting'] | None = None,
) -> qdk_chemistry.algorithms.term_grouper.commuting.QubitWiseCommutingTermGrouper: ...

@overload
def create(
    algorithm_type: Literal['term_grouper'],
    algorithm_name: Literal['identity'] | None = None,
) -> qdk_chemistry.algorithms.term_grouper.identity.IdentityTermGrouper: ...

@overload
def create(
    algorithm_type: Literal['term_grouper'],
    algorithm_name: Literal['nx_commuting'] | None = None,
) -> qdk_chemistry.plugins.networkx.term_grouper.NxFullCommutingTermGrouper: ...

@overload
def create(
    algorithm_type: Literal['term_grouper'],
    algorithm_name: Literal['nx_qubit_wise_commuting'] | None = None,
) -> qdk_chemistry.plugins.networkx.term_grouper.NxQubitWiseCommutingTermGrouper: ...
...
def create(
    ...
    encoding: str = "jordan-wigner",
) -> qdk_chemistry.plugins.openfermion.qubit_mapper.OpenFermionQubitMapper: ...
...
) -> qdk_chemistry.algorithms.hamiltonian_unitary_builder.time_evolution.trotter.Trotter: ...
...
def create(
    ...
    seed: unknown = -1,
    time: float = 0.0,
) -> qdk_chemistry.algorithms.hamiltonian_unitary_builder.time_evolution.qdrift.QDrift: ...
...
) -> qdk_chemistry.algorithms.hamiltonian_unitary_builder.time_evolution.partially_randomized.PartiallyRandomized: ...

@overload
def create(
    algorithm_type: Literal['controlled_circuit_mapper'],
    algorithm_name: Literal['pauli_sequence'] | None = None,
) -> qdk_chemistry.algorithms.controlled_circuit_mapper.pauli_sequence_mapper.PauliSequenceMapper: ...
...
def create(
    ...
    seed: unknown = 42,
    transpile_optimization_level: unknown = 0,
) -> qdk_chemistry.plugins.qiskit.circuit_executor.QiskitAerSimulator: ...
...
def create(
    ...
    circuit_executor: AlgorithmRef = AlgorithmRef(type='circuit_executor', name='qdk_sparse_state_simulator'),
    circuit_mapper: AlgorithmRef = AlgorithmRef(type='controlled_circuit_mapper', name='pauli_sequence'),
    num_bits: unknown = -1,
...
def create(
    ...
    shots: unknown = 3,
    unitary_builder: AlgorithmRef = AlgorithmRef(type='hamiltonian_unitary_builder', name='trotter'),
) -> qdk_chemistry.plugins.qiskit.standard_phase_estimation.QiskitStandardPhaseEstimation: ...
