...
def create(
    ...
    **kwargs,
) -> Union[Algorithm | qdk_chemistry.algorithms.active_space_selector.QdkAutocasActiveSpaceSelector | qdk_chemistry.algorithms.active_space_selector.QdkAutocasEosActiveSpaceSelector | qdk_chemistry.algorithms.active_space_selector.QdkOccupationActiveSpaceSelector | qdk_chemistry.algorithms.active_space_selector.QdkValenceActiveSpaceSelector | qdk_chemistry.algorithms.dynamical_correlation_calculator.DynamicalCorrelationCalculator | qdk_chemistry.algorithms.energy_estimator.qsharp.QDKEnergyEstimator | qdk_chemistry.algorithms.hamiltonian_constructor.QdkHamiltonianConstructor | qdk_chemistry.algorithms.multi_configuration_calculator.QdkMacisAsci | qdk_chemistry.algorithms.multi_configuration_calculator.QdkMacisCas | qdk_chemistry.algorithms.orbital_localizer.QdkMP2NaturalOrbitalLocalizer | qdk_chemistry.algorithms.orbital_localizer.QdkPipekMezeyLocalizer | qdk_chemistry.algorithms.orbital_localizer.QdkVVHVLocalizer | qdk_chemistry.algorithms.projected_multi_configuration_calculator.QdkMacisPmc | qdk_chemistry.algorithms.qubit_hamiltonian_solver.DenseMatrixSolver | qdk_chemistry.algorithms.qubit_hamiltonian_solver.SparseMatrixSolver | qdk_chemistry.algorithms.scf_solver.QdkScfSolver | qdk_chemistry.algorithms.state_preparation.sparse_isometry.SparseIsometryGF2XStatePreparation | qdk_chemistry.plugins.qiskit.energy_estimator.QiskitEnergyEstimator | qdk_chemistry.plugins.qiskit.qubit_mapper.QiskitQubitMapper | qdk_chemistry.plugins.qiskit.regular_isometry.RegularIsometryStatePreparation]: ...
