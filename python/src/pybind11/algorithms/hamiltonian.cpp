...
void bind_hamiltonian_constructor(py::module &m) {
  ...
  py::class_<HamiltonianConstructor, HamiltonianConstructorBase,
    ...
    This class defines the interface for constructing Hamiltonian matrices
    from orbital data. Concrete implementations should inherit from this class
    and implement the construct method.
