...
void bind_cc(py::module &m) {
  ...
  py::class_<CoupledClusterCalculator, CoupledClusterCalculatorBase,
    ...
    This class defines the interface for coupled cluster-based quantum chemistry
  ...
  cc_calculator.def(py::init<>(),
        ...
        Configuration options such as convergence criteria and maximum
        iterations can be modified through the ``settings()`` method.
