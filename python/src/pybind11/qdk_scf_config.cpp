...
void bind_qdk_chemistry_config(py::module& m) {
  ...
  py::class_<qcs::QDKChemistryConfig>(m, "QDKChemistryConfig", R"(
        ...
        This class provides access to QDKChemistry configuration functionality,
        including resource directory management and other configuration options.
      ...
      .def_static(
        ...
        ----------
        path : str
            The new resources directory path.
