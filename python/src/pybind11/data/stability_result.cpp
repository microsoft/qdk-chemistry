...
void bind_stability_result(py::module &m) {
  py::class_<StabilityResult, DataClass, py::smart_holder> stability_result(
    ...
    of the stability matrix for both internal and external stability.
  ...
  stability_result.def(
      ...
      R"(
        ...
        Parameters
        ----------
        internal_stable : bool
            True if internal stability is satisfied
        external_stable : bool
            True if external stability is satisfied
        internal_eigenvalues : numpy.ndarray
            Eigenvalues of the internal stability matrix
        internal_eigenvectors : numpy.ndarray
            Eigenvectors of the internal stability matrix
        external_eigenvalues : numpy.ndarray
            Eigenvalues of the external stability matrix
        external_eigenvectors : numpy.ndarray
            Eigenvectors of the external stability matrix
  ...
  stability_result.def("get_smallest_internal_eigenvalue",
                       ...
                       ------
                       RuntimeError
                           If no internal eigenvalues are present
                       )");
  ...
  stability_result.def("get_smallest_external_eigenvalue",
                       ...
                       ------
                       RuntimeError
                           If no external eigenvalues are present
                       )");
  ...
  stability_result.def("to_file", stability_result_to_file_wrapper,
        ...
        ------
        RuntimeError
            If the stability result data is invalid, unsupported type, or file cannot be opened/written
  ...
  stability_result.def_static("from_file", stability_result_from_file_wrapper,
        ...
        RuntimeError
            If the file cannot be opened, read, or contains invalid stability result data
  ...
  stability_result.def("to_hdf5_file", stability_result_to_hdf5_file_wrapper,
        ...
        data structures, making it ideal for storing stability analysis results.

        Parameters
        ----------
        filename : str or pathlib.Path
            Path to the HDF5 file to write. Must have '.stability_result' before the file
            extension (e.g., ``water.stability_result.h5``, ``molecule.stability_result.hdf5``)
        ...
        RuntimeError
            If the stability result data is invalid or the file cannot be opened/written
  ...
  stability_result.def_static("from_hdf5_file",
        ...
        ----------
        filename : str or pathlib.Path
            Path to the HDF5 file to read. Must have '.stability_result' before the
            file extension (e.g., ``water.stability_result.h5``, ``molecule.stability_result.hdf5``)
  ...
  stability_result.def(
      ...
      R"(
        ...
        ------
        RuntimeError
            If the stability result data is invalid
  ...
  stability_result.def_static(
      ...
      R"(
        ...
        ----------
        json_str : str
            JSON string containing stability result data
        ...
        ------
        RuntimeError
            If the JSON string is malformed or contains invalid stability result data
  ...
  stability_result.def("to_json_file", stability_result_to_json_file_wrapper,
        ...
        ----------
        filename : str or pathlib.Path
            Path to the JSON file to write. Must have '.stability_result' before the file
            extension (e.g., ``water.stability_result.json``, ``molecule.stability_result.json``)
  ...
  stability_result.def_static("from_json_file",
        ...
        ----------
        filename : str or pathlib.Path
            Path to the JSON file to read. Must have '.stability_result' before the file
            extension (e.g., ``water.stability_result.json``, ``molecule.stability_result.json``)
