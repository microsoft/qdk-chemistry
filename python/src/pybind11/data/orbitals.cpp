...
void bind_orbitals(py::module &data) {
  ...
  py::class_<Orbitals, DataClass, py::smart_holder> orbitals(data, "Orbitals",
    ...
    The class provides methods to calculate atomic orbital density matrices from
    occupation vectors or reduced density matrices (RDMs) passed as parameters.
  ...
  orbitals.def(
      ...
      R"(
        ...
        indices : tuple of (list of int, list of int), optional
            Tuple of (active_space_indices, inactive_space_indices), can be ``None``
  ...
  orbitals.def(
      ...
      R"(
        ...
        Parameters
        ----------
        occupations_alpha : numpy.ndarray
            Alpha spin occupation vector (size must match number of MOs)
        occupations_beta : numpy.ndarray
            Beta spin occupation vector (size must match number of MOs)
        ...
        ------
        RuntimeError
            If occupation vector sizes don't match number of MOs
  ...
  orbitals.def("calculate_ao_density_matrix",
        ...
        occupations : numpy.ndarray
            Total occupation vector (size must match number of molecular orbitals)
        ...
        ------
        RuntimeError
            If occupation vector size doesn't match number of MOs
  ...
  orbitals.def(
      ...
      R"(
        ...
        Parameters
        ----------
        rdm_alpha : numpy.ndarray
            Alpha 1RDM in MO basis (size must match number of MOs × MOs)
        rdm_beta : numpy.ndarray
            Beta 1RDM in MO basis (size must match number of MOs × MOs)
        ...
        ------
        RuntimeError
            If 1RDM matrix sizes don't match number of MOs
  ...
  orbitals.def("calculate_ao_density_matrix_from_rdm",
        ...
        ----------
        rdm : numpy.ndarray
            1RDM in MO basis (size must match number of MOs × MOs)
        ...
        ------
        RuntimeError
            If 1RDM matrix size doesn't match number of MOs
  ...
  orbitals.def("to_file", orbitals_to_file_wrapper,
        ...
        ------
        RuntimeError
            If the orbital data is invalid, unsupported type, or file cannot be opened/written
  ...
  orbitals.def_static("from_file", orbitals_from_file_wrapper,
      ...
      type : str
        ...
        RuntimeError
            If the file cannot be opened, read, or contains invalid orbital data
  ...
  orbitals.def("to_hdf5_file", orbitals_to_hdf5_file_wrapper,
        ...
        ----------
        filename : str or pathlib.Path
            Path to the HDF5 file to write. Must have '.orbitals' before the file
            extension (e.g., ``water.orbitals.h5``, ``molecule.orbitals.hdf5``)
        ...
        RuntimeError
            If the orbital data is invalid or the file cannot be opened/written
  ...
  orbitals.def_static("from_hdf5_file", orbitals_from_hdf5_file_wrapper,
        ...
        ----------
        filename : str or pathlib.Path
            Path to the HDF5 file to read. Must have '.orbitals' before the
            file extension (e.g., ``water.orbitals.h5``, ``molecule.orbitals.hdf5``)
  ...
  orbitals.def(
      ...
      R"(
        ...
        ------
        RuntimeError
            If the orbital data is invalid
  ...
  orbitals.def_static(
      ...
      R"(
        ...
        ----------
        json_str : str
            JSON string containing orbital data
        ...
        ------
        RuntimeError
            If the JSON string is malformed or contains invalid orbital data
  ...
  orbitals.def("to_json_file", orbitals_to_json_file_wrapper,
        ...
        ----------
        filename : str or pathlib.Path
            Path to the JSON file to write. Must have '.orbitals' before the file
            extension (e.g., ``water.orbitals.json``, ``molecule.orbitals.json``)
  ...
  orbitals
      .def_static("from_json_file", orbitals_from_json_file_wrapper,
        ...
        ----------
        filename : str or pathlib.Path
            Path to the JSON file to read. Must have '.orbitals' before the file
            extension (e.g., ``water.orbitals.json``, ``molecule.orbitals.json``)
...
void bind_model_orbitals(py::module &data) {
  ...
  model_orbitals.def(
      ...
      R"(
        ...
        For restricted calculations, the same active and inactive space
        indices are used for both alpha and beta electrons.
        ...
        ------
        ValueError
            If indices are >= basis_size or if active and inactive spaces overlap
  ...
  model_orbitals.def(
      ...
      R"(
        ...
        For unrestricted calculations, separate active and inactive space
        indices can be provided for alpha and beta electrons.
  ...
  model_orbitals
      .def_static(
        ...
        ----------
        json_str : str
            JSON string containing ``ModelOrbitals`` data
        ...
        ------
        RuntimeError
            If the JSON string is malformed or contains invalid ``ModelOrbitals`` data
