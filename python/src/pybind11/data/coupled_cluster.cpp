...
void bind_coupled_cluster(pybind11::module& data) {
  ...
  coupled_cluster.def(py::init<const CoupledClusterAmplitudes&>(),
        ...
        Parameters
        ----------
        other : CoupledClusterAmplitudes
            The amplitude object to copy
  ...
  coupled_cluster.def(
      ...
      R"(
        ...
        t1_amplitudes : numpy.ndarray
            The T1 amplitudes vector
        t2_amplitudes : numpy.ndarray
            The T2 amplitudes vector (flattened from 4D tensor)
  ...
  coupled_cluster.def("has_t1_amplitudes",
        ...
        -------
        bool
            True if T1 amplitudes are set, false otherwise
  ...
  coupled_cluster.def("has_t2_amplitudes",
        ...
        -------
        bool
            True if T2 amplitudes are set, false otherwise
  ...
  coupled_cluster.def("get_num_occupied",
        ...
        -------
        tuple
            A tuple of two integers ``(alpha_count, beta_count)`` containing the
  ...
  coupled_cluster.def("get_num_virtual",
        ...
        tuple
            A tuple of two integers ``(alpha_count, beta_count)`` containing the
            number of virtual orbitals for each spin channel.
