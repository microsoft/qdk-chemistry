...
void bind_ansatz(pybind11::module& data) {
  ...
  ansatz.def(py::init<const Hamiltonian&, const Wavefunction&>(),
        ...
        ------
        ValueError
            If orbital dimensions are inconsistent between Hamiltonian and wavefunction
        )",
  ...
  ansatz.def(
      ...
      R"(
        ...
        ------
        ValueError
            If pointers are None or orbital dimensions are inconsistent
        )",
      py::arg("hamiltonian"), py::arg("wavefunction"));
  ...
  ansatz.def("calculate_energy", &Ansatz::calculate_energy,
        ...
        ------
        RuntimeError
            If calculation cannot be performed
  ...
  ansatz.def("validate_orbital_consistency",
        ...
        ------
        RuntimeError
            If orbital dimensions are inconsistent
        )");
  ...
  ansatz.def("to_file", &ansatz_to_file_wrapper,
        ...
        ------
        RuntimeError
            If unsupported type or I/O error occurs
        )",
  ...
  ansatz.def_static("from_file", &ansatz_from_file_wrapper,
        ...
        ------
        RuntimeError
            If file doesn't exist, unsupported type, or I/O error occurs
        )",
                    py::arg("filename"), py::arg("type"));
