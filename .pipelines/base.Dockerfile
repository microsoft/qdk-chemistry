...
FROM quantumapps.azurecr.io/nvidia/cuda:12.1.0-devel-ubuntu22.04 AS base-x86_64
FROM quantumapps.azurecr.io/nvidia/cuda:12.1.0-devel-ubuntu22.04-arm64 AS base-aarch64
