...
- Distinguish ab initio molecular Hamiltonians from model Hamiltonians.
- Identify the degrees of freedom and parameters in selected lattice models.
- Construct a model Hamiltonian with :term:`QDK`/Chemistry.
...
.. todo::
   ...
   Add an exercise that changes a model parameter or lattice and asks the learner to predict a qualitative effect.

Further reading
===============

- :doc:`Model Hamiltonians <../../../user/comprehensive/model_hamiltonians>`
- :doc:`Lattice graphs <../../../user/comprehensive/data/lattice_graph>`
