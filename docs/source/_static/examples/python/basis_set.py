...
# With explicit ECP
basis_from_name_ecp = BasisSet.from_basis_name("sto-3g", structure, "def2-ecp")
...
index_basis_map = {0: "cc-pvdz", 1: "sto-3g", 2: "sto-3g"}  # O at 0, H at 1 and 2
basis_from_index = BasisSet.from_index_map(index_basis_map, structure)
# With explicit ECP per atom index
index_ecp_map = {0: "def2-ecp"}  # ECP only for atom at index 0
