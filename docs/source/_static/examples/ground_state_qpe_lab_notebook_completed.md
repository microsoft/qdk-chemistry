...
- Complete-run bitstring counts: Environment-dependent; the script output records the sampled distribution.
...
- Supporting evidence: Exact mapped/CASCI agreement, modal bitstring 010000, and the reconstructed total-energy comparison.
