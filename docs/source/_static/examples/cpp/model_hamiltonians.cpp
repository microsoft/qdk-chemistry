...
int main() {
  ...
  auto hamiltonian = create_huckel_hamiltonian(lattice, /*epsilon=*/0.0, /*t=*/1.0);
  ...
  auto hub_hamiltonian = create_hubbard_hamiltonian(hub_lattice, /*epsilon=*/0.0, /*t=*/1.0, /*U=*/4.0);
  ...
  auto square_lattice = LatticeGraph::square(4, 4, /*periodic_x=*/true, /*periodic_y=*/true);
  auto square_hamiltonian = create_hubbard_hamiltonian(square_lattice, /*epsilon=*/0.0, /*t=*/1.0, /*U=*/4.0);
  ...
  auto ppp_hamiltonian = create_ppp_hamiltonian(
    ring,
    /*epsilon=*/0.0,
    /*t=*/2.4,
    /*U=*/11.26,
  ...
  auto site_dep_hamiltonian = create_hubbard_hamiltonian(chain, /*epsilon=*/0.0, /*t=*/1.0, /*U=*/U_values);
  ...
  auto V_ohno = ohno_potential(pot_lattice, /*U=*/11.26, /*R=*/1.4, /*epsilon_r=*/1.0);

  // Mataga-Nishimoto potential: V_ij = U_ij / (1 + U_ij * epsilon_r * R_ij / C)
  auto V_mn = mataga_nishimoto_potential(pot_lattice, /*U=*/11.26, /*R=*/1.4, /*epsilon_r=*/1.0);
  ...
  auto solve_hamiltonian = create_hubbard_hamiltonian(solve_lattice, /*epsilon=*/0.0, /*t=*/1.0, /*U=*/4.0);

  // Run exact diagonalization (CASCI) with half filling (2 alpha + 2 beta)
  auto mc_calculator = qdk::chemistry::algorithms::create("multi_configuration_calculator", "macis_cas");
