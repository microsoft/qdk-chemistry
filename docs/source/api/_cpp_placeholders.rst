...
.. cpp:type:: size_t
   ...
   Placeholder target for documents that refer to ``size_t``.
...
.. cpp:type:: Args
   ...
   Placeholder target for documents that refer to ``Args``.

.. cpp:class:: optional

   Placeholder target for documents that refer to ``optional``.

.. cpp:class:: callable

   Placeholder target for documents that refer to ``callable``.
