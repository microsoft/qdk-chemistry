...
See :doc:`comprehensive/algorithms/phase_estimation` for detailed documentation on available implementations and usage, and :doc:`comprehensive/algorithms/unitary_builder` for the Hamiltonian simulation methods that underpin phase estimation.
