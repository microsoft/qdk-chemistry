...
```python
evolution_builder = create("hamiltonian_unitary_builder", "trotter")
```
...
iqpe.settings().set("shots_per_bit", 3)
result = iqpe.run(
...
for point in pareto_front:
    print(point.qubits, point.runtime, point.error)
```
