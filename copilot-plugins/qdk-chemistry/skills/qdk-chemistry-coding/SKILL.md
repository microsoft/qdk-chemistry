...
| `hamiltonian_unitary_builder` | U = exp(-iHt) | `trotter` |
| `controlled_circuit_mapper` | Controlled-U circuit | `pauli_sequence` |
...
qpe.settings().set("qpe_circuit_builder", AlgorithmRef(
    "qpe_circuit_builder", "qdk_iterative",
    num_bits=10,
    unitary_builder=AlgorithmRef("hamiltonian_unitary_builder", "trotter", time=0.5),
    controlled_circuit_mapper=AlgorithmRef("controlled_circuit_mapper", "pauli_sequence"),
))
qpe.settings().set("shots_per_bit", 3)
# ... configure executor and run
```
