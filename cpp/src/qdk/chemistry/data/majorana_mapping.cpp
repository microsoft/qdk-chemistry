...
using detail::bk_flip_set;
using detail::bk_parity_set;
using detail::bk_remainder_set;
using detail::bk_update_set;
using detail::build_sorted_word;
using detail::next_power_of_two;
using detail::OP_X;
using detail::OP_Y;
using detail::OP_Z;
