...
// On-demand engine.
// Same arithmetic, ordering, and thresholds as majorana_map_impl.
// Restricted, sparse integrals only.
template <std::size_t NW, class EriProvider>
...
using LargeWordCounts = std::index_sequence<32, 64, 128, 256, 512, 1024, 2048>;
