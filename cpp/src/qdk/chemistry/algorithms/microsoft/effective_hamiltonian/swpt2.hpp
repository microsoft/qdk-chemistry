 ...
 public:
  SchriefferWolffPT2Settings() {
    ...
    set_default(
        ...
        "folding costs several times the kernel time. Ignored when the kept "
        "space holds at most two electrons, where the discarded terms cannot "
        "contribute.");
    set_default(
 ...
 * the reference-normal-ordered residual. Discarding is the larger error once
 * the kept space holds more than two electrons; folding costs several times the
 * kernel time.
 *
