...
INSTANTIATE_TEST_SUITE_P(RKS_INCORE_h2o, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_CPU_h2o, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_DFJ_h2o, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(UKS_INCORE_h2o, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(UKS_CPU_h2o, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_INCORE_h2o_cart, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_CPU_h2o_cart, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(UKS_INCORE_h2o_cart, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(UKS_CPU_h2o_cart, SCFTest, ::testing::Values(
...
/* ==================== O2 UHF-DFJ, pure =========================*/
INSTANTIATE_TEST_SUITE_P(UHF_DFJ_o2, SCFTest, ::testing::Values(
  std::make_tuple("o2", "UHF-DFJ/HF/def2-svp/def2-universal-jfit/pure", "INCORE",  "DEFAULT", "GAUXC", 1e-8, 1e-8)
));
INSTANTIATE_TEST_SUITE_P(UKS_DFJ_bf, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_INCORE_water10, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_CPU_water10, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(UKS_INCORE_water10, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(UKS_CPU_water10, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_INCORE_water10_cart, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(UKS_INCORE_water10_cart, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RHF_LINEAR_DEP, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_HGP_Rd_c2h4, SCFTest, ::testing::Values(
  std::make_tuple("read_guess", "RKS/B3LYP/def2-svp/Rd", "CPU", "CPU", "GAUXC", 1e-6, 1e-5)));
/* ==================== Read Guess, O UKS, pure ======================== */
INSTANTIATE_TEST_SUITE_P(UKS_CPU_Rd_o, SCFTest, ::testing::Values(
  std::make_tuple("read_guess", "UKS/B3LYP/def2-svp/Rd", "CPU", "CPU", "GAUXC", 1e-6, 1e-5)));

/* ==================== GAUXC Tests ===================== */
INSTANTIATE_TEST_SUITE_P(RKS_CPU_GAUXC_h2o, SCFTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(RKS_LEVEL_SHIFTING, SCFTest, ::testing::Values(
  std::make_tuple("benzene", "RKS/PBE/cc-pvdz", "INCORE", "DEFAULT", "GAUXC", 1e-8, 1e0)
  ));
