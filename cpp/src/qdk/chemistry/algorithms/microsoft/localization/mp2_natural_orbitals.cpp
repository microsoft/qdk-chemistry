...
std::shared_ptr<data::Wavefunction> MP2NaturalOrbitalLocalizer::_run_impl(
  ...
  gemm("N", "N", num_atomic_orbitals, num_orbitals, num_orbitals, 1.0,
       selected_coeffs.data(), num_atomic_orbitals, mp2_natural_orbitals.data(),
       num_orbitals, 0.0, selected_no_coeffs.data(), num_atomic_orbitals);
