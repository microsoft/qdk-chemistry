 ...
 * methods.
 */
class Canonical4CenterHamiltonian : public DataClass,
                    public std::enable_shared_from_this<Canonical4CenterHamiltonian> {
 public:
  /**
   ...
   */
  virtual std::unique_ptr<Canonical4CenterHamiltonian> clone() const override;
